...
Melee::Melee(Hero& hero, Monster& monster)
  : hero(hero)
  , monster(monster)
{
}

Outcome Melee::predictOutcome() const
{
  ...
  return Outcome{summary, std::make_optional(std::move(heroAfterFight)), std::move(monsterAfterFight)};
}
